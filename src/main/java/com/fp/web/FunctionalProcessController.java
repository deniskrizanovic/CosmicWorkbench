...
public class FunctionalProcessController {
	...
	@RequestMapping(value = "/disp-functional-processes", method = {
			RequestMethod.GET, RequestMethod.POST})
	public String dispFunctionalProcess(Model model,
	...
	public String showFunctionalProcess(Model model,
										HttpServletRequest request, HttpSession session) {
	...
	public String createSystemContext(Model model, HttpServletRequest request,
		...
		String functionalprocessname = request
				.getParameter("functionalprocessname");
		String functionalprocessnotes = request
				.getParameter("functionalprocessnotes");
		String functionalsubprocessname = request
				.getParameter("functionalsubprocessname");
		int version = 0;
			...
			if (systemContextId != 0l) {
				if (request.getParameter("option") != null
					...
					if (this.functionalProcess != null
						...
						functionalProcessId = this.functionalProcess
					...
					if (functionalProcessId != 0l
							&& functionalsubprocessname != null
	...
	@RequestMapping(value = "/show-functional-processes", method = {
			RequestMethod.GET, RequestMethod.POST})
	public String getFunctionalProcess(Model model, HttpServletRequest request,
			HttpSession session) {

		if (session.getAttribute("systemcontextid") != null) {
			if (request.getParameter("functionalprocessid") != null
					&& !(request.getParameter("functionalprocessid") + "")
					.equals("")) {
				Long name = (Long) session.getAttribute("systemcontextid");
				String functionalprocessname = request
						.getParameter("functionalprocessid");
				List<FunctionalProcess> actors = this.jdbcTemplate
						.query("select functionalprocessid, version, name, notes from functionalprocess where not deleteflag and systemcontextid = "
										+ name + "",
								new RowMapper<FunctionalProcess>() {
